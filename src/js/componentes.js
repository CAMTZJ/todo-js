...
divTodoList.addEventListener('click', (event) =>{
    ...
    const nombreElemento = event.target.localName;  // esto solo puede ser un input, label o button porque es lo unico q tenemos
    ...
    } else if ( nombreElemento.includes('button') ){ // si incluye el boton hay que borrar el todo
